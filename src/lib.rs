...
use crate::info_write::{info_write, info_write_array, info_write_force_size};
...
pub const WT_DEFBASE: u16 = 0x7FF0;
...
pub const CXO_SYSTEM: u16 = 0x0001;
pub const CXO_PEN: u16 = 0x0002;
pub const CXO_MESSAGES: u16 = 0x0004;
pub const CXO_MARGIN: u16 = 0x8000;
pub const CXO_MGNINSIDE: u16 = 0x4000;
pub const CXO_CSRMESSAGES: u16 = 0x0008;
...
pub const DEVICES_NAME_LEN: usize = 64;
#[repr(C)]
...
const CRC_MULTIMODE: u32 = 0x0001;
const CRC_AGGREGATE: u32 = 0x0002;
const CRC_INVERT: u32 = 0x0004;

pub const CURSORS_NAME_LEN: usize = 64;
#[repr(C)]
...
pub const LOGICAL_CONTEXT_NAMELEN: usize = 40;
#[repr(C, align(4))]
...
impl WtiLogicalContext {
    ...
    pub fn handle_info(&self, index: u32, lp_output: *mut c_void) -> u32 {
        match index {
            // wtinfo is VERY hard on enforcing this struct being 212 bytes, but I failed
            // to align it to this size in any way.
            0 => info_write_force_size(self, lp_output, 212),
